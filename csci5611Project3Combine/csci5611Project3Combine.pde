...
float old_a0, old_a1, old_la1, old_la2, old_la3, old_ra1, old_ra2, old_ra3;
...
void solve(){
  ...
  } while(lineBallCollision(start_r3, endPoint2));
  ...
  do{
    ...
    fk();
  } while(lineBallCollision(start_r2, endPoint2) || lineBallCollision(start_r2, start_r3));
  ...
  do{
    ...
    fk();
  } while(lineBallCollision(start_b2, endPoint2) || lineBallCollision(start_b2, start_r2) || lineBallCollision(start_r2, start_r3));
  //************************************************************
  ...
  do{
    ...
    fk();
  }while(lineBallCollision(start_l3, endPoint));
  ...
  do{
    ...
    fk();
  }while(lineBallCollision(start_l2, endPoint) || lineBallCollision(start_l2, start_l3));
  ...
  }while(lineBallCollision(start_b2, endPoint) || lineBallCollision(start_b2, start_l2) || lineBallCollision(start_l2, start_l3));
